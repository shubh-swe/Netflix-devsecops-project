...
- Provision an Compute Engine VM  instance on GCP  with Ubuntu 22.04.
- Connect to the instance using SSH.

**Step 2: Clone the Code:**

- Update all the packages and then clone the code.
- Clone your application's code repository on to the Compute Engine instance:
    
    ```bash
    git clone https://github.com/shubh-swe/Netflix-devsecops-project
    ```
    

**Step 3: Install Docker and Run the App Using a Container:**

- Set up Docker on the compute Engine/EC2 instance:
...
1. **Install SonarQube and Trivy:**
    - Install SonarQube and Trivy on the Compute Engine/EC2 instance to scan for vulnerabilities.
...
1. **Install Jenkins for Automation:**
    ...
    - Access Jenkins in a web browser using the public IP of your Compute Engine/EC2 instance.
...
pipeline {
    ...
    stages {
        ...
        stage('Checkout from Git') {
            steps {
                git branch: 'main', url: 'https://github.com/shubh-swe/Netflix-devsecops-project.git'
            }
        }
...
pipeline {
    ...
    stages {
            ...
            steps {
                script {
                    withDockerRegistry(credentialsId: 'docker', toolName: 'docker') {
                        sh "docker build --build-arg TMDB_V3_API_KEY=c28285fef41a42d1acaa8e469e779f9e -t netflix ."
                        sh "docker tag netflix airforce7/netflix:latest"
                        sh "docker push airforce7/netflix:latest"
                    }
                }
            }
        }
        ...
        stage('Deploy to Container') {
            steps {
                sh 'docker run -d --name netflix -p 8081:80 airforce7/netflix:latest'
            }
        }
    }
    ...
    post {
        success {
            emailext(
                to: 'shubhamdwivedi.spacepilot@gmail.com',
